 ...
 */
public class PrimitiveArrayRelationModelElement {
    ...
    public PrimitiveArrayRelationModelElement(final FieldElement fieldElement, final ModelElement typeElement, final List<FieldElement> fieldElements) {
