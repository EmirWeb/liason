...
public class ViewModelCreatorTest {
    ...
    public void CreatesViewModelWithPathAction() {
        ...
        final JavaFileObject metaJavaFileObject = JavaFileObjects.forSourceString("Product", Joiner.on("\n").join(
                ...
                "   public static Cursor customQuery(final Context context, final SQLiteDatabase sqLiteDatabase, final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder) {",
                "       return null;",
                "   }",
                "}"));
        ...
        final JavaFileObject expectedJavaFileObject = JavaFileObjects.forSourceString("ProductViewModel", Joiner.on("\n").join(
                ...
                "       if (path.equals(new Path(\"PATH1/Path2/#\"))) {",
                "           return Product.customQuery(context, sQLiteDatabase, uri, projection, selection, selectionArguments, sortOrder);",
                "       }",
